# Quickstart Guide: Integrated RAG Chatbot for Humanoid Robotics Docusaurus Book
...
1. Add the ChatKit widget script to your `static/` directory
2. Include the script in your Docusaurus `index.html` template
